...
var HTML5toTouch = require('react-dnd-multi-backend/dist/cjs/HTML5toTouch');
...
var HTML5toTouch__default = /*#__PURE__*/_interopDefaultLegacy(HTML5toTouch);
...
var getTreeItem = function (tree, id) {
    ...
    return immer.produce(node, function () { });
};
...
var mutateTree = function (tree, dragSourceId, dropTargetId, index) {
    ...
    return immer.produce(newTree, function (draft) {
...
var Providers = function (props) { return (React__default['default'].createElement(TreeProvider, __assign({}, props),
    React__default['default'].createElement(DragControlProvider, null,
        React__default['default'].createElement(PlaceholderProvider, null,
            React__default['default'].createElement(reactDndMultiBackend.DndProvider, { options: HTML5toTouch__default['default'] }, props.children))))); };
...
var useOpenIdsHelper = function (tree, initialOpen) {
    ...
    var handleToggle = React.useCallback(function (targetId) {
    ...
    var handleCloseAll = React.useCallback(function () { return setOpenIds([]); }, []);
    var handleOpenAll = React.useCallback(function () {
        return setOpenIds(tree.filter(function (node) { return node.droppable; }).map(function (node) { return node.id; }));
    }, [tree]);
    var handleOpen = React.useCallback(function (targetIds) {
    ...
    var handleClose = React.useCallback(function (targetIds) {
...
var Container = function (props) {
    ...
    return (React__default['default'].createElement(Component, { ref: ref, className: className, role: "list" },
